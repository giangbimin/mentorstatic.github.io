...
$(document).ready(function($){
  ...
  function changeTheme(theme) {
    ...
    if (theme == "default") {
      $('head link[data-name=themes]').attr('href', 'css/colors/default.min.css');
    ...
    if (theme == "dark") {
      $('head link[data-name=colors]').attr('href', 'css/colors/orange.min.css');
      $.getScript('js/colors/google_map_orange.min.js', function() { });
    }
    if (theme == "light") {
      $('head link[data-name=colors]').attr('href', 'css/colors/belize_hole.min.css');
      $.getScript('js/colors/google_map_belize_hole.min.js', function() { });
    }
  }
  ...
  function changeColor(color) {
    ...
    if (color == "default") {
      $('head link[data-name=colors]').attr('href', 'css/colors/default.min.css');
    } else {
